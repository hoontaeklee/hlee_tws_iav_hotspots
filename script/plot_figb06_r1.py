...
plot_timeseries_tws_met_simplified_regions(
    arr_tws=region_tws_nonhotspots_mean,
    arr_met=region_ppt_nonhotspots_mean[0],
    arr_size=region_cnt_nonhotspots,
    ylim_tws=param_dict['ylim_tws_non'],
    ylim_met=param_dict['ylim_met_non'],
    title=param_dict['title_non'],
    met='ppt')
save_name = os.path.join(dir_plot, 'figb06.png')
