...
# wRiver (mm)
path = os.path.join(dir_data, 'SINDBAD_opti_Nov2021/Routing_VEG_3_0.5/VEG_3_05_wRiver_monthly_masked_simul_2001_2019.nc')  # with gpcp1dd
...
# save
save_name = os.path.join(dir_plot, 'fig07.png')
fig.savefig(
    save_name,
    dpi=600,
    facecolor='w',
