...
# load tws iav res
path = os.path.join(dir_data, 'cov_TWS_det_resid_scArea_det_using_20022017_simul_2001_2019_mswep.npz')  # forced with mswep ppt
...
save_name = os.path.join(dir_plot, 'figb21.png')
fig.savefig(
    save_name,
    dpi=300,
    bbox_inches='tight',
