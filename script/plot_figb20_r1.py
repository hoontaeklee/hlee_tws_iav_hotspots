...
# tws iav norm. cov.
path = os.path.join(dir_data, 'cov_TWS_det_scArea_det_using_20022017_simul_2001_2019_mswep.npz')  # forced with mswep ppt
cov = np.load(path)
...
save_name = os.path.join(dir_plot, 'figb20.png')
fig.savefig(
    save_name,
    dpi=300,
    bbox_inches='tight',
